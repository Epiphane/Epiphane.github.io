...
function LevelManager() {
   this.levels = [
      ...
      new Level("Listen!", "for (var = 0;  < array.length; ++) {var o = array[];}", [{id: 6, amt: 1}, {id: 5, amt: 1}],
          [{enemy: TankEnemy, delay: 50, amount: 5}, {enemy: SuperCorrupter, delay: 2, amount: 50},
             {enemy: TankEnemy, delay: 50, amount: 5}, {enemy: SuperCorrupter, delay: 2, amount: 50}]),
      new Level("Oh dear", "ERROR: Intruder detected. Removing....", [{id: 7, amt: 1}],
          [{enemy: MiniKingCorrupter, delay: 5, amount: 1}]),
      new Level("i'M Getng", "Through! We're ˜∂∆˚∑˜¬ß    ˆ¨œß∆ß  ßœøˆ", [{id: 5, amt: 1}],
          [{enemy: BasicShootingEnemy, delay: 50, amount: 5}, {enemy: BasicMovingEnemy, delay: 50, amount: 5},
             {enemy: Corrupter, delay: 1, amount: 100}, {enemy: BasicShootingEnemy, delay: 100, amount: 10}]),
      new Level("Okay I almost got", "NullPointerException: main has no attribute frame", [{id: 5, amt: 1}, {id: 4, amt: 1}],
          [{enemy: SuperCorrupter, delay: 2, amount: 200}, {enemy: MovingShootingEnemy, delay: 50, amount: 5},
             {enemy: TankEnemy, delay: 100, amount: 10}, {enemy: SuperCorrupter, delay: 2, amount: 100}]),
      new Level("We made it!", "Stop the Space Corrupter!", [{id: 0, amt: 1}],
